...
|-----------|--------|---------------------------|
| local clone — resolve on any host: `readlink -f ~/.claude/skills/to-spec` → `<checkout>/skills/engineering/to-spec` | Matt Pocock | 25 skills across 5 categories (engineering, productivity, personal, misc, in-progress) |
...
**Local Clone:** resolve on any host: `readlink -f ~/.claude/skills/to-spec` → `<checkout>/skills/engineering/to-spec`  
