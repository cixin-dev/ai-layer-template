...
- **Do-not**:
  ...
  - Every PR must include a Traditional Chinese `## 變更說明` section in the PR body (繁體中文 summary of what changed and why) — this is enforced by CI. (retroactive: pr-zh-description-gate)
